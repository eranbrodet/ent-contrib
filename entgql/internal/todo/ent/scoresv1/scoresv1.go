...
const (
	// Label holds the string label denoting the scoresv1 type in the database.
	Label = "scores_v1"
	...
	EdgeScores = "Scores"
	// Table holds the table name of the scoresv1 in the database.
	Table = "scores_v1s"
	...
	ScoresColumn = "scores_v1_scores"
)

// Columns holds all SQL columns for scoresv1 fields.
var Columns = []string{
	FieldID,
	FieldScore,
}
